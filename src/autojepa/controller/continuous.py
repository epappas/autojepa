...
from autojepa.controller.engine import IterationCallback, run_experiment
...
from autojepa.policy.learned_search import LearnedParamPolicy, LearnedSearchConfig
from autojepa.policy.llm_search import LLMParamPolicy
from autojepa.policy.search import GridPolicy, RandomPolicy, StaticPolicy
...
def _build_llm_diff_policy(
    ...
    from autojepa.policy.llm_diff import LLMDiffPolicy
...
def _make_on_keep_callback(mutable_file: str) -> IterationCallback:
    from autojepa.controller.diff_executor import _persist_diff
...
def run_continuous(
    *,
    ...
    if controller.parallel.enabled and policy_cfg.type not in {"llm_diff", "hybrid"}:
        ...
        from autojepa.controller.parallel_engine import run_experiment_parallel
