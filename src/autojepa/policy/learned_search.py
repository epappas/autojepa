...
from autojepa.checkpoint import (
    get_latest_snapshot_version,
    load_policy_snapshot,
    save_policy_snapshot,
)
from autojepa.policy.gae import compute_gae, compute_returns
from autojepa.policy.ppo import PPOAgent, PPOConfig
from autojepa.policy.sdpo import compute_kl_divergence, compute_sdpo_loss
...
class LearnedParamPolicy:
    ...
    def _compute_teacher_kl(self, states: np.ndarray) -> float:
        ...
        for i in range(states.shape[0]):
            ...
            from autojepa.policy.ppo import _softmax
