...
from autojepa.config_validate import has_blocking_errors, validate_runtime
from autojepa.controller.continuous import (
    _diff_extractor,
    _param_extractor,
    run_continuous,
)
from autojepa.target.registry import build_target
...
def run(
    ...
    """Continuous AutoJEPA run (always on)."""
...
def status(
    ...
    if cfg.controller.checkpoint_path:
        from autojepa.checkpoint import load_checkpoint
...
def run_one(
    ...
    from autojepa.controller.one_shot import OneTimePolicy
...
def upload(
    ...
    with tempfile.NamedTemporaryFile(mode="w", suffix=".json", delete=False) as f:
        ...
        api.upload_file(
            ...
            path_in_repo="autojepa_version.json",
            repo_id=repo,
            commit_message="autojepa version metadata",
        )
