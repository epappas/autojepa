...
from autojepa.eval.metrics import parse_metric_series, parse_metrics
from autojepa.forecasting import _fit_power_law_points
from autojepa.sandbox.diff_utils import extract_touched_files_from_diff
...
def _ensure_git_repo(workdir: str) -> tuple[bool, str]:
    ...
    _run_git(workdir, "config", "user.name", "AutoJEPA Scaffold")
