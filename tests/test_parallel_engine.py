...
from autojepa.policy.interface import Learnable, ParamProposal
from autojepa.policy.search import RandomPolicy
...
def test_parallel_cancel_fires_with_real_subprocess(tmp_path: Path) -> None:
    ...
    from autojepa.config import IntraIterationCancelConfig
    ...
    script.write_text(textwrap.dedent(f"""
        ...
        from autojepa.target.progress import emit_progress
