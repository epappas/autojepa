...
from autojepa.policy.interface import ParamProposal, propose_batch
from autojepa.policy.llm_search import LLMParamPolicy, _parse_batch_response
...
def test_llm_batch_returns_distinct_lrs(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    with patch(
        "autojepa.policy.llm_search._call_chat_api_messages",
        return_value=canned,
    ):
